...
import type { Deck, Product, VideoScene } from '../types.ts';
import { audioTracks } from '../data/mockAudio.ts';
import type { AudioTrack } from '../data/mockAudio.ts';
import { CloseIcon, SparklesIcon, FilmIcon, PlayIcon, PauseIcon, UploadIcon } from './Icons.tsx';
