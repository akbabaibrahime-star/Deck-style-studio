...
import { MailIcon, MapPinIcon, LinkIcon } from './Icons.tsx';
    ...
    <div className="bg-black text-white h-screen overflow-y-auto pb-8">
      <div className="p-4 space-y-6 pt-8">
        ...
        <div className="space-y-2 pt-4 border-t border-gray-800">
          ...
          <a href={mapUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-gray-400">
